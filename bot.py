...
async def cmd_rules(message: Message, state: FSMContext):
    ...
    rules_text = (
        ...
        "1. <b>Категорії:</b> дотримуйся умов кожної — читай уважно.\n"
        "2. <b>Авторство:</b> лише власний контент. Без плагіату.\n"
        "3. <b>Оформлення:</b> до 5 зображень у пості.\n"
        "4. <b>Частота:</b> не більше 2 публікацій на 7 днів.\n"
        "5. <b>Підтримка:</b> зроби репост <a href='https://t.me/c/2865535470/16'>нашого допису</a> або надішли бот 3 друзям.\n"
        "6. <b>Контент:</b> заборонено NSFW, образи, незаконне.\n"
        "7. <b>Модерація:</b> заявки можуть бути відхилені без пояснень.\n\n"
        "<b>❓ Маєш питання?</b> Напиши: <code>@AdminUsername</code>\n"
