...
# 📋 Категорії з піратськими описами-правилами
CATEGORIES = {
    "⚓️ 💰 Платні послуги": {
        "description": (
            "1. 18+ — під цензуру, як і в рекламі.\n"
            "2. Репост головного допису обов’язковий.\n"
            "3. Додай прайс-лист (ніяких «потім домовимось»).\n"
            "4. Мінімальна ціна — 50 грн.\n"
            "5. Приклади робіт і дедлайни обов’язкові.\n"
            "6. Вкажи способи оплати.\n"
            "7. Російські та проросійські фандоми — за борт!"
        ),
        "hashtag": "#ТворчіПропозиції"
    },
    "🏴‍☠️ 📣 Промо соцмереж": {
        "description": (
            "1. 18+ — ховаємо під цензуру.\n"
            "2. Перед публікацією — репост основного оголошення.\n"
            "3. Додай посилання на порт, де стоїть твоя реклама.\n"
            "4. Жодної аморальщини.\n"
            "5. Російська мова та проросійські фандоми — за борт!"
        ),
    ...
    "🦜 🎉 Активності": {
        "description": (
            "1. 18+ — під цензуру.\n"
            "2. Скрін репосту — твій квиток на борт.\n"
            "3. Додай опис, банер і посилання на оригінал.\n"
            "4. Жодної проросійщини та російських фандомів!"
        ),
        "hashtag": "#ТворчіАктивності"
    },
    "🔎 🖋️ У пошуках критики/фідбеку": {
        "description": (
            "1. 18+ — під цензуру, ховаємо за парусами.\n"
            "2. Без сторонніх посилань у пості чи коментарях.\n"
            "3. Жодної аморальності чи цькувань.\n"
            "4. Російські та проросійські фандоми — за борт!\n"
            "5. Інформацію перевіряй, не годуй чайок байками."
        ),
        "hashtag": "#ПошукФідбеку"
    },
    "📢 🏴‍☠️ Оголошення": {
        "description": (
            "1. Дотримуйся правил безпечної гавані.\n"
            "2. Жодних російських і проросійських фандомів.\n"
            "3. Інформацію підтверджуй фактами.\n"
            "4. Не допускай образ і аморального контенту."
        ),
        "hashtag": "#Оголошення"
    },
    "🌟 🧭 Інше": {
        "description": (
            "1. Дотримуйся загальних правил корабля.\n"
            "2. 18+ — під цензуру.\n"
            "3. Жодної проросійщини та аморальності.\n"
            "4. Якщо сумніваєшся — звернись до модератора."
        ),
        "hashtag": "#ТворчийМікс"
    }
}
