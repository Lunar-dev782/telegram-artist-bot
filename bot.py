...
CATEGORIES = {
    "⚓️ 💰 Платні послуги": {
        "description": (
            ...
            "<a href='https://t.me/mytci_ua/14'> Зроби репост""нашої спільноти</a> 🦜\n\n"
            "— 18+ — під цензуру.\n"
    ...
    "🏴‍☠️ 📣 Промо соцмереж": {
        "description": (
            ...
            "<a href='https://t.me/mytci_ua/14'>Сквааак! Основні вимоги — Зроби репост нашої спільноти</a> 🦜\n\n"
    ...
    "🔎 🖋️ У пошуках критики/фідбеку": {
        "description": (
            "📜 <b>Якщо шукаєш критики, поради чи хочеш залишити відгук тобі сюди.</b>\n"
    ...
    "📢 🏴‍☠️ Оголошення": {
        "description": (
            "🔔 <b>Тут важливі новини та інформація для екіпажу.</b>\n"
            "<a href='https://t.me/mytci_ua/14'>Сквааак! Основні вимоги — Зроби репост нашої спільноти</a> 🦜\n\n"
...
async def cmd_rules(message: Message, state: FSMContext):
    ...
    "5. Підтримка: репост ([Натисни тут🦜](https://t.me/c/2865535470/16)) "
    "або поділись ботом з трьома друзями.\n\n"
    ...
    "🛠 <b>Модератори:</b>\n"
    "— Мають право: Відхиляти пости, видавать бан або обмеження\n\n"

    "❓ Питання? Пиши в наш чат\n"
    "🔗 Повна версія правил: [тут](https://t.me/c/2865535470/16)"
)
