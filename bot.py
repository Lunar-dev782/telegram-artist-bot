...
async def show_main_menu(message: Message, state: FSMContext):
    ...
    try:
        ...
        await message.answer(
            "🎨 <b>🦜 Сквааак! Привіт, матросе! Ти на борту Митецького Порту ім. Капітанки М’юз! Я — вірний папуга Капітанки, глашатай і писар цього корабля. Сквааак! Якщо маєш пост чи новину для екіпажу — кидай мені в дзьоб, а я віднесу на дошку оголошень! Пам’ятай: тримай контент у межах нашого уставу, бо інакше отримаєш скваак-догану! 🏴‍☠️</b>",
            parse_mode="HTML",
            reply_markup=ReplyKeyboardMarkup(
                keyboard=[
