...
# 🔐 Токен бота
TOKEN = "7645134499:AAHmTzyzo8_HjKdkECtrJKEkQE7AtcOBSpU"
...
CATEGORIES = {
    "💰 Платні пропозиції": {
        "description": "Продаєш коміші, адопти чи інші творчі штуки? Покажи їх із репостом!",
        "hashtag": "#ТворчіПропозиції"
    },
    "📣 Промо соцмереж": {
        "description": "Розкручуй свої канали, блоги чи профілі! Репост — твій ключ до слави.",
        "hashtag": "#ПромоСоцмереж"
    },
    "🎉 Активності": {
        "description": "Запалюй з івентами, конкурсами, реквестами чи іншими креативними тусами!",
        "hashtag": "#ТворчіАктивності"
    },
    "🔎 У пошуках критики/фідбеку": {
        "description": "Хочеш чесну думку про свою творчість? Тобі сюди!",
        "hashtag": "#ПошукФідбеку"
    },
    "📢 Оголошення": {
        "description": "Ділися новинами чи зверненнями. Пиши, репост не треба!",
        "hashtag": "#Оголошення"
    },
    "🌟 Інше": {
        "description": "Не вписується в інші категорії? Покажи свій унікальний вайб!",
        "hashtag": "#ТворчийМікс"
    }
}
...
async def cmd_rules(message: Message, state: FSMContext):
    ...
    rules_text = (
        "<b>📖 Вітаємо в спільноті <i>Митці ЮА</i>!</b>\n"
        "<b>🔥 Основні правила публікацій:</b>\n\n"
        "<i>1.</i> <u>Дотримуйся умов кожної категорії</u> — уважно читай вимоги!\n"
        "<i>2.</i> <i>Надсилай лише свій оригінальний контент</i> — ніякого плагіату.\n"
        "<i>3.</i> <s>Максимум 5 зображень на пост</s> — тримай усе компактно.\n"
        "<i>4.</i> Пости не частіше, ніж <b>2 рази на 7 днів</b>.\n"
        "<i>5.</i> Зроби <b>репост</b> <a href='https://t.me/c/2865535470/16'>нашого допису</a> в соцмережі або надішли 3 друзям.\n"
        "<i>6.</i> <s>Заборонено NSFW, образи чи незаконний контент</s> — поважай інших!\n"
        "<i>7.</i> Адміни можуть <i>відхилити заявку</i> — рішення остаточне.\n\n"
        "<b>📩 Є питання?</b> Пиши: <code>@AdminUsername</code>\n"
        "<b>👉 Деталі:</b> <a href='https://t.me/c/2865535470/16'>Докладні правила</a>"
    )
    await message.answer(
        rules_text,
        parse_mode="HTML",
