...
async def cmd_rules(message: Message, state: FSMContext):
    ...
    rules_text = (
    "<b>🏴‍☠️ Правила спільноти <i>Митці ЮА</i></b>\n\n"
    
    "<b>📌 Публікація рекламних постів:</b>\n"
    "1. <b>18+</b> під цензуру! Капітанка М’юз не хоче, аби корабель потонув через скарги Telegram.\n"
    "2. Перед публікацією — надай скриншот репосту основного оголошення.\n"
    "3. Додай <b>посилання на порт</b>, де пришвартував рекламу.\n"
    "4. Без аморального контенту та його прославляння. Ми будуємо <i>безпечну гавань</i>.\n"
    "5. Російська мова та проросійські фандоми — <u>за борт</u>!\n\n"

    "<b>⚓ Публікація платних послуг:</b>\n"
    "1. <b>18+</b> під цензуру, як і в рекламі.\n"
    "2. Підтверди репост головного допису.\n"
    "3. Обов’язково вкажи <b>прайс-лист</b> (ніяких «домовимось потім»).\n"
    "4. Мінімальна ціна — <b>50 грн</b>. Шануй свою працю.\n"
    "5. Додай приклади робіт та чіткі дедлайни.\n"
    "6. Вкажи способи оплати. Уникай «штормових» ситуацій.\n"
    "7. Жодних російських чи проросійських фандомів.\n\n"

    "<b>🦜 Публікація івентів та активностей:</b>\n"
    "1. <b>18+</b> ховаємо під цензуру.\n"
    "2. Скрін репосту — твій <b>квиток на борт</b>.\n"
    "3. Обов’язкові: опис івенту, банер і посилання на оригінал.\n"
    ...
    "5. Інформацію підтверджуємо — не годуй чайок байками.\n\n"
