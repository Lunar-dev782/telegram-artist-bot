...
# 📋 Категорії та їх хештеги у форматі MarkdownV2
CATEGORIES = {
    "💰 Платні послуги⚓": {
        "description": (
            "🏴‍☠️ *Тут матроси виставляють творчі послуги за оплату.*\n"
            "— 18+ — під цензуру.\n"
            "— Репост головного допису _обов’язковий_.\n"
            "— Додай прайс-лист (мінімум 50 грн).\n"
            "— Приклади робіт і дедлайни.\n"
            "— Вкажи способи оплати.\n"
            "— Російські та проросійські фандоми — ~за борт~!\n\n"
            "🔗 Посилання на репост: [Натисни тут🦜](https://t.me/mytci_ua/14)"
        ),
    ...
    "🏴‍☠️ 📣 Промо соцмереж": {
        "description": (
            "🦜 *Тут рекламують свої арт-сторінки та профілі.*\n"
    ...
    "🦜 🎉 Активності": {
        "description": (
            "⚓ *Тут організовують конкурси, челенджі та івенти.*\n"
            "— 18+ — під цензуру.\n"
            "— Репост основного оголошення.\n"
    ...
    "🔎 🖋️ У пошуках критики/фідбеку": {
        "description": (
            "📜 *Якщо шукаєш критики, поради чи хочеш залишити відгук — сюди.*\n"
            "— Пост у цій категорії є анонімним.\n"
            "— 18+ — під цензуру.\n"
            "— Без сторонніх посилань.\n"
            "— Жодної аморальності чи цькувань.\n"
            "— Російські та проросійські фандоми — за борт!\n"
            "— Інформацію перевіряй."
        ),
    ...
    "📢 🏴‍☠️ Оголошення": {
        "description": (
            "🔔 *Тут важливі новини та інформація для екіпажу.*\n"
    ...
    "🌟 🧭 Інше": {
        "description": (
            "🗺️ *Тут усе інше творчого характеру.*\n"
            "— Дотримуйся загальних правил корабля.\n"
            "— 18+ — під цензуру.\n"
            "— Жодної проросійщини та аморальності.\n"
            "— Якщо сумніваєшся — звернись до адміністратора."
        ),
        "hashtag": "#ТворчийМікс",
        "repost": False,
        "anonymous": False
...
def send_category_message(bot, chat_id, category_name):
    ...
    bot.send_message(
        ...
        parse_mode="MarkdownV2",       # <-- змінили з HTML на MarkdownV2
...
async def handle_category_selection(message: Message, state: FSMContext):
    ...
    if category_config.get("repost", False):
        await message.answer(
            f"Категорія <b>{category}</b>: {category_config['description']}\n\n"
