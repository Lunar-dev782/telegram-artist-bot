    ...
    try:
        ...
        if not subscription_status:
            await message.answer(
                "🦜 Сквааак! Ви не підписані на наш канал! "
                "Будь ласка, підпишіться за посиланням: "
                "<a href='https://t.me/mytci_ua'>Перейти до каналу</a> "
                "і натисніть 'Я підписався(лась). Скваак!'.",
                parse_mode="HTML",
        ...
        await message.answer(
            ...
            "Я — вірний папуга Капітанки, <b>глашатай і писар</b> цього корабля. "
            "<b>Сквааак!</b>\n\n"
            "📌 Якщо маєш <b>пост чи новину</b> для екіпажу — кидай мені в дзьоб, "
            "а я віднесу на <u>дошку оголошень</u>!\n\n"
            "⚠️ <b>Пам’ятай:</b> тримай контент у межах нашого уставу, "
            "бо інакше отримаєш <i>скваак-догану</i>! 🏴‍☠️",
            parse_mode="HTML",
        ...
        await message.answer(
            "🦜 Виникла помилка. Сквааак! "
            "Спробуйте ще раз або зверніться до <code>@tina263678</code>.",
            parse_mode="HTML",
            reply_markup=main_menu_kb
        )
        await state.set_state(Form.main_menu)
